...
const TabContent: React.FC<TabContentProps> = ({
  ...
  const [selectedAutomation, setSelectedAutomation] = useState<number | null>(
    null
  );
            ...
            {automations.map((automation, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  onClick={() =>
                    setSelectedAutomation(isSelected ? null : index)
                  }
                  whileHover={{ scale: 1.02 }}
                >
                    ...
                    <motion.div
                      className={`p-3 rounded-xl transition-colors ${
                        isSelected
                          ...
                          : "bg-black/10 group-hover/item:bg-black/20"
                      }`}
...
export const ServiceTabs: React.FC = () => {
  ...
  useEffect(() => {
    const scriptExists = document.querySelector(
      'script[src="https://thunder.voiceaiservice.com/react-widget-uv.iife.js"]'
    );

    if (!scriptExists) {
      const processScript = document.createElement("script");
      processScript.innerHTML = "window.process = { env: {} };";
      document.body.appendChild(processScript);

      const widgetScript = document.createElement("script");
      widgetScript.src =
        "https://thunder.voiceaiservice.com/react-widget-uv.iife.js";
      widgetScript.async = true;
      document.body.appendChild(widgetScript);
    }

    // Load the widget after the script is ready
    const widgetElement = document.createElement("react-widget-uv");
    widgetElement.setAttribute(
      "agent_id",
      "503df982-453c-4426-8411-a7186cca9dd4"
    );
    widgetElement.setAttribute(
      "schema",
      "6af30ad4-a50c-4acc-8996-d5f562b6987f"
    );
    widgetRef2.current?.appendChild(widgetElement);
    return () => {
      if (widgetRef2.current) {
        widgetRef2.current.innerHTML = ""; // Clears all children
      }
    };
  }, [activeTab]);
  ...
  useEffect(() => {
    const scriptExists = document.querySelector(
      'script[src="https://vision.voiceaiservice.com/react-widget.iife.js"]'
    );
    ...
    if (!scriptExists) {
      ...
      const widgetScript = document.createElement("script");
      widgetScript.src =
        "https://vision.voiceaiservice.com/react-widget.iife.js";
      widgetScript.async = true;
      document.body.appendChild(widgetScript);
    }

    // Load the widget after the script is ready
    const widgetElement = document.createElement("react-widget");
    widgetElement.setAttribute(
      "agent_id",
      "aea8565d-4133-4c57-aa90-82dfe1befb87"
    );
    widgetElement.setAttribute(
      "schema",
      "6af30ad4-a50c-4acc-8996-d5f562b6987f"
    ...
    return () => {
      if (widgetRef.current) {
        widgetRef.current.innerHTML = ""; // Clears all children
      }
    };
  }, [activeTab]);
  ...
  const tabs = [
    {
      ...
      description:
        "Intelligent website assistant that handles customer queries 24/7",
      features: [
    ...
    },
    {
      ...
      price: "$4.50",
      image:
        "https://cdn3d.iconscout.com/3d/premium/thumb/ai-robot-assistant-with-headphone-5662753-4719373.png",
      description:
        "AI-Powered CRM system that handles calls and customer interactions",
      features: [
    ...
    },
    {
      ...
      price: "$3.90",
      image:
        "https://cdn3d.iconscout.com/3d/premium/thumb/robot-chatting-on-smartphone-5662755-4719375.png",
      description:
        "Powerful automation suite for streamlined business operations",
      stats: [
      ...
      automations: [
        ...
        },
        {
          ...
          integrations: ["Google Calendar", "Outlook", "iCal", "Zoom"],
        },
        {
          icon: Mail,
          ...
          integrations: ["Mailchimp", "Sendgrid", "AWS SES", "Mandrill"],
        },
        {
          icon: BellRing,
          ...
          integrations: ["Slack", "Discord", "Teams", "Webhook"],
        },
        {
          ...
          integrations: ["Excel", "Google Sheets", "Airtable", "MongoDB"],
        },
        {
          icon: Workflow,
        ...
        },
        {
          ...
          integrations: ["Tableau", "Power BI", "Looker", "Metabase"],
        },
        {
          icon: ShoppingCart,
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        >
          Choose the perfect plan to automate and scale your operations with our
